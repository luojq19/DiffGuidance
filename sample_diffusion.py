...
if __name__ == '__main__':
    ...
    parser.add_argument('--classifier_path', type=str, default='/work/jiaqi/DiffMol/3d_synth_noised_log/exp_crsd_noise0_no_edge-20230408-0622')
    ...
    parser.add_argument('--cls_mode', type=str, default='molecule', choices=['molecule', 'protein'])
    ...
    model = ScorePosNet3D(
        ...
        cls_type_only=args.type_only,
        cls_pos_only=args.pos_only,
    ...
    if args.generate_noised_data:
        ...
        model.generate_noised_data(src_file='/work/jiaqi/DiffMol/molecule_synth_data/crossdocked100k_balanced_size.pt',
            save_path=f'/work/jiaqi/DiffMol/molecule_synth_data/crossdocked100k_balanced_size-renoised-{args.guide_timestep}.pt')
        exit()
